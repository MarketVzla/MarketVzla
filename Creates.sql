...
constraint fk_juridico foreign key (pre_fk_juridico) references juridico(cli_codigo),
...
constraint fk_despacho foreign key (des_fk_proveedor) references proveedor(pro_rif),
...
eje_fk_despacho integer not null,
eje_fk_zona integer,
eje_fk_compra integer,
eje_fk_presupuesto integer,
constraint pk_ejemplar primary key (eje_codigo),
constraint fk_producto foreign key (eje_fk_producto) references producto(pro_codigo),
constraint fk_despacho foreign key (eje_fk_despacho) references despacho (des_codigo),
constraint fk_zona foreign key (eje_fk_zona) references zona(zon_codigo),
constraint fk_compra foreign key (eje_fk_compra) references compra(com_codigo),
constraint fk_presupuesto foreign key (eje_fk_presupuesto) references presupuesto(pre_codigo)
);
create table oferta (
ofe_codigo serial,
...
constraint fk_juridico foreign key (usu_fk_juridico) references juridico(cli_codigo),
constraint fk_natural foreign key (usu_fk_natural) references "natural"(cli_codigo),
constraint fk_empleado foreign key (usu_fk_empleado) references empleado(emp_ci)
);
...
constraint fk_usuario foreign key (rp_usuario) references usuario(usu_nick)
);
